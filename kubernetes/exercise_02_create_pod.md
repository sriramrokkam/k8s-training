...
It's time to clean up - go and delete the pod you created. But before open a second shell and run `kubectl get pods --watch` (or `watch kubectl get pods` if you have the `watch` utility installed).
